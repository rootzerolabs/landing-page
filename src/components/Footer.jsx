  ...
  return (
    <footer className="py-20 bg-background border-t border-white/5">
      <div className="container mx-auto px-6">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-6 group cursor-pointer">
              <div className="relative w-10 h-10 flex items-center justify-center">
                <div className="absolute inset-0 bg-accent-primary/20 blur-lg rounded-full animate-pulse opacity-50" />
                <svg 
                  viewBox="0 0 24 24" 
                  className="relative w-full h-full text-accent-primary drop-shadow-[0_0_8px_rgba(108,99,255,0.6)]"
                  fill="none" 
                  stroke="currentColor" 
                  strokeWidth="2.5" 
                  strokeLinecap="round" 
                ...
                >
                  <path d="M2 13h2l3 7 6-16h9" />
                  <g transform="translate(15.5, 9.5) skewX(-15)">
              ...
              <span className="text-xl font-heading font-black tracking-tighter text-white uppercase italic">
                Root<span className="text-accent-primary">Zero</span><span className="ml-1 text-white/20">Labs</span>
              </span>
            </div>
            <p className="text-white/40 text-sm leading-relaxed mb-4">
              Building the software layer between where your business is and where it needs to be. High-performance software & AI solutions.
            </p>
            <p className="text-xs font-black text-accent-primary uppercase tracking-[0.2em] mb-6">
              Root Cause. Zero Friction.
            </p>
            <div className="flex space-x-5">
              {/* LinkedIn */}
              <a href="#" className="text-white/30 hover:text-accent-primary transition-all hover:scale-110">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 text-xs text-white/30 uppercase tracking-widest gap-4">
